...
const AutoScrollBrands = () => {
  return (
    <div style={{
      ...
      <div className="relative  w-full md:px-0 md:w-[95%] max-w-[1444px] mx-auto lg:ml-auto   flex flex-col md:flex-row items-center gap-6 sm:gap-8 md:gap-10 overflow-hidden">
        {/* <Image
        ...
        <div className="w-full px-[18px] md:w-2/5">
          <div className="relative text-black text-left py-3 flex flex-col items-start justify-center gap-3 md:gap-4">
            ...
            <p className="m-0 font-inter text-[16px] md:text-[18px] font-inter-medium w-full text-center md:text-left lg:text-left">
              Earn with every Brand you Love.
            </p>
          </div>
        </div>
      ...
      >
        ...
        <div ref={contentRef} className="flex flex-col">
          {[...logos, ...logos].map((logo, index) => (
            <div key={index} className="flex justify-center my-1.5 lg:my-4 bg-[#fff] border-[2px] border-[#f1437e]/20 p-2 h-25 md:h-35 lg:h-30   w-25 md:w-35 lg:w-30 rounded-[20px]">
              <img
                src={logo.logo}
                alt={logo.name}
