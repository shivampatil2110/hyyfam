...
const CreatorJoin = () => {
  ...
  return (
    <div className="relative w-full h-auto">
      ...
      <div className="relative px-[18px] w-full md:px-0 md:w-[95%] lg:w-[90%] max-w-[1444px] mx-auto py-16 md:py-[96px] z-0">
        <div className="relative bg-[#FFF2F6] overflow-hidden rounded-[42px] pt-[40px] px-10 z-20 flex flex-col-reverse md:flex-row items-center justify-start md:justify-center gap-10 lg:gap-14">
          {/* <svg
          ...
          />
          <Image
            className="z-30 w-[100%] md:w-1/2 md:mb-[-170px] lg:mb-[-80px] xl:mb-0"
            src={"/static/lowerSection.png"}
            alt="phone"
            height={500}
            width={700}
          />
...
Team up with the top-tier brands and boost your earnings with Hyyfam
