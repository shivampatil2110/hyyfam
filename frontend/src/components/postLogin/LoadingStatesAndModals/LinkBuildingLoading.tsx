...
export const DotsSpinnerRotating: React.FC<DotsSpinnerLoadingProps> = ({
  isLoading,
  className = "",
  size = "md",
}) => {
  ...
  return (
    <div className="h-screen  relative overflow-x-scroll [&::-webkit-scrollbar]:hidden font-inter bg-[#FFF3F7] w-full flex flex-col items-center justify-center gap-5">
      <div className="flex flex-col items-center justify-center gap-2 w-[60%] mx-auto">
        ...
        <p className="text-[14px] font-normal leading-5 text-center font-inter">
         Keep calm & whisk that matcha, we will be done in a sip!
        </p>
      </div>
      <div
            ...
            <div
              ...
              style={{
                ...
                transform: `translate(-50%, -50%) rotate(${
                  ...
                  size === "sm" ? "12px" : size === "md" ? "16px" : "24px"
                })`,
                opacity: 1 - index * 0.1,
              }}
            />
